<template>
  ...
  <div>  
    ...
    <textarea :id="adminCommentCtrlId" :screenNum="screenNum" style="display:none;" placeholder="Add Comment" class="is-request-data is-admin-comment form-control form-control-sm"></textarea>
  </div>
