...
export default {
    data () {
        return {
            ...
            navOutRoutePath: "/admin/manageaccounts",
    ...
    computed: {
        ...
        emailSubject() {
            return this.$store.state.appConfig.adminAddEmailSubject; 
        },

        emailTemplate() {
            return this.$store.state.appConfig.adminAddEmailTemplate; 
        },
    ...
    activated() {
        console.log('SendAdminAddEmail.vue activated.');
